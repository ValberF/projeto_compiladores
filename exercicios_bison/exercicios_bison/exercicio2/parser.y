...
exp: termo               
  | exp ADD termo       { $$ = novo_no("+",$1,$3);}
  | exp SUB termo       { $$ = novo_no("-",$1,$3);}
  ;

termo: fator           
    | termo MUL fator  { $$ = novo_no("*",$1,$3);}
    | termo DIV fator  { $$ = novo_no("/",$1,$3);}
    ;

fator: NUM  {$$ = novo_no($1,NULL,NULL);}          
    ;
